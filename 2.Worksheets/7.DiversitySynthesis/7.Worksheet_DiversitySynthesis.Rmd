...
# read in data
gummy.total <- read.csv("/Users/emnadols/GitHub/QB2023_Nadolski/2.Worksheets/7.DiversitySynthesis/QBDataWranglingLab.csv",header=TRUE, row.names=2)
